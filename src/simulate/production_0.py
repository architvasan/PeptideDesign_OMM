...
if __name__ == "__main__": 
    ...
    prod_dcd = f'{args.rep_loc}/prod0/prod0.dcd'
    prod_rst = f'{args.rep_loc}/prod0/prod0.rst.chk'
    prod_chkpt = f'{args.rep_loc}/prod0/prod0.chk'
    prod_st = f'{args.rep_loc}/prod0/prod0.state'
    prod_log = f'{args.rep_loc}/prod0/prod0.csv'
